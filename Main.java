	...
	public static void main(String[] args) {
		...
		do {
			...
			case 5:
				...
				if (curso != null) {
					...
					if (idDisciplina > 0) {
						...
						System.out.println("Informe a descricao da disciplina:");
						descricao = scanner.nextLine();

						if (disciplinaService.insert(idDisciplina, nome, descricao, curso) == true) {
							curso.insertDisciplina(disciplinaService.getById(idDisciplina));
						...
						System.out.println(
								"Id da disciplina inválida, favor informar somente números inteiros positivos");
					}
				} else {
					System.out.println("Curso não encontrado");
				}
			...
			case 6:
				...
				disciplina = disciplinaService.getById(idDisciplina);
			...
			case 7:
				...
				if (disciplina != null) {
					...
					if (curso != null) {
						...
						System.out.println("Informe a nova descricação da disciplina:");
						descricao = scanner.nextLine();
						if (disciplinaService.update(idDisciplina, nome, descricao, curso) == true) {
			...
			case 8:
				...
				if (disciplina != null) {
					if (disciplinaService.delete(idDisciplina) == true) {
						...
						System.out.println("Falha ao tentar remover o disciplina");
					}
				} else {
					System.out.println("Disciplina não encontrada");
				}
